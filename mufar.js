...
const daftar2 = '*Created © SallXd Offcial*'
...
// Wadefak Men
const fmen = { key : { participant : '0@s.whatsapp.net'}, message: {orderMessage: {itemCount : 2021, status: 1, surface : 1, message: `© Sallxd Official`, thumbnail: fs.readFileSync('./src/Mufar.jpg'), sellerJid: '0@s.whatsapp.net'}}}
const fdoc = { key: { participant : '0@s.whatsapp.net'}, message: {documentMessage: {title: `© Sallxd Official`, jpegThumbnail: thumb}}}
...
const fgif = { key: { participant: '0@s.whatsapp.net', ...(from ? { remoteJid: "6283871990243-1613049930@g.us" } : {})}, message: {"videoMessage": { "title":`© Sallxd Official`, "h": `Hmm`,'seconds': '99999', 'gifPlayback': 'true', 'caption': `© Sallxd Official`, 'jpegThumbnail': thumb}}}
const fgclink = { key: { participant: '0@s.whatsapp.net', "remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6283871990243-1616169743@g.us","inviteCode": "m","groupName": "Xrutz Official", "caption": `© Sallxd Official`, 'jpegThumbnail': thumb}}}
const fvideo = { key: { fromMe: false, participant: '0@s.whatsapp.net', ...(from ? { remoteJid: "6283871990243-1613049930@g.us" } : {})}, message: { "videoMessage": { "title":`© Sallxd Official`, "h": `Hmm`,'seconds': '99999', 'caption': `© Sallxd Official`, 'jpegThumbnail': thumb}}}
const floc = { key: { participant : '0@s.whatsapp.net'}, message: {locationMessage: {name: `© Sallxd Official`, jpegThumbnail: thumbz}}}
const fakevo = { key: { fromMe: false, participant: '0@s.whatsapp.net', remoteJid: 'status@broadcast'}, message: {imageMessage: {mimetype: 'image/jpeg', caption: 'Sallxd Selfbot', jpegThumbnail: fs.readFileSync('./src/Mufar.jpg'), viewOnce: true}}}
...
{ buttonId: `${prefix}owner`, buttonText: { displayText: 'Creator SallxdBot' }, type: 1 }
]
...
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fmen})
nama = '𝗦𝗮𝗹𝗹𝗫𝗱 𝗢𝗳𝗳𝗶𝗰𝗶𝗮𝗹'
ownerJid = "6281286819346@s.whatsapp.net"
...
footerText: '*_© Sallxd - Official Bot_*',
description: `${tampilUcapan} ${pushname}, *Hallo User @${sender.split('@')[0]}, Silahkan pilih menu Sallxd-Bot disini*`,
sections: [
                 {
                 "title": `${week}, ${calender}`,
 rows: [
...
case 'rulesbot':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fmen})
ruls =`*Syarat & Ketentuan SallxdBot.ೃ🐣*
...
*Silahkan lanjut gunakan Sallxd Bot!*`
...
members_ids.push(mem.jid)
            ...
            + 'END:VCARD'.trim()
            Mufar.sendMessage(from, {displayName: `Name YT : SallXd`, vcard: vcard2}, contact, 
            { quoted: fmen, 
            })
            replyWithFakeLink('*Ini Nomor Owner Sallxd BOT*\nMau Chat? Utamakan Salam!')
            limitAdd(sender, limit)
            break
...
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fmen})
but = [{ buttonId: `${prefix}owner`, buttonText: { displayText: 'Chat Owner' }, type: 1 }]
sendButton(from, "Donasi Dong Om\n*Sc Dari Youtube Kok*", faketeks, but, mek)
limitAdd(sender, limit)
lbreak
...
Mufar.sendMessage(from, buffer, image, {quoted: mek, caption: '*© Sallxd Official*'})
limitAdd(sender, limit)
break
...
const btnbc = {
contentText: `${q}`,
footerText: '*BROADCAST SALLXD BOT*',
buttons: buttonss,
headerType: 1
}
...
case 'addrespon':
if (!isOwner && !mek.key.fromMe) return reply(mess.only.owner)
if (args.length < 1) return reply(`Example : ${prefix}addrespon Subs SallXd|Y`)
argz = arg.split('|')
...
case 'delrespon':
if (!isOwner && !mek.key.fromMe) return reply(mess.only.owner)
if (args.length < 1) return reply(`Example : ${prefix}delrespon Subs SallXd`)
